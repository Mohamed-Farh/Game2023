...
@section('title', 'قائمة العاب ال9 رقم')
    ...
    <div class="container">
        <div class="row ">
            <div class="col-6 d-flex text-left">
                <h1 class=" text-left">قائمة العاب ال9 رقم </h1>
            </div>
            <div class="col-6 d-flex justify-content-end">
                <a href="{{ route('admin.nine-games.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <table class="table table-bordered table-hover table-striped table-light yajra-datatable">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            @ability('superAdmin', 'manage_eight_games,edit_eight_games')
                                <td class="text-center">
                            ...
                            @endability
                            <td class="text-center">
                                <a href="{{ route('admin.nine-games.showPrices', $item->id) }}" target="_blank">
                            ...
                            <td nowrap="nowrap">
                                @ability('superAdmin', 'manage_nine_games,update_nine_games')
                                    <a href="{{ route('admin.nine-games.edit', $item->id) }}"
                                ...
                                @ability('superAdmin', 'manage_nine_games,delete_nine_games')
                                    ...
                                    <form action="{{ route('admin.nine-games.destroy', $item->id) }}" method="post" id="record_delete_{{ $item->id }}" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                @endability
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        text: 'Delete All',
                        url: "{{ route('admin.nine-games.massDestroy') }}",
        ...
        $(function () {
            $('.status-class').change(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{ route('admin.nine-games.changeStatus') }}',
                    data: {
                        'status': status,
                        'cat_id': cat_id
                    },

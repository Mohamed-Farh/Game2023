                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <select name="account_status" class="form-control form-control-solid">
                                <option value="">الحالة</option>
                                <option value="1" {{ old('account_status', request()->input('account_status')) == '1' ? 'selected' : '' }}>نشط</option>
                                <option value="0" {{ old('account_status', request()->input('account_status')) == '0' ? 'selected' : ''  }}>غير نشط</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-2">

    ...
    <div class="container">
        <div class="card-header py-3 d-flex">
            ...
            <div class="col-6 text-right">
                <a href="{{ route('admin.hundred-games.showPrices', $hundredGame->id) }}" class="btn btn-primary">
        ...
        <div class="card card-custom gutter-b example example-compact">
            <!--begin::Form-->
            <form action="{{ route('admin.prices.store', ['hundredGame' => $hundredGame]) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div>

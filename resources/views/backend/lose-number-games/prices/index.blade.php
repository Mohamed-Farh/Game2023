...
@section('title', 'قائمة الجوائز الرقم الخاسر')
    ...
    <div class="container">
        <div class="row ">
            <div class="col-6 d-flex text-left">
                <h1 class=" text-left">قائمة الجوائز الرقم الخاسر</h1>
            </div>
            <div class="col-6 d-flex justify-content-end">
                <a href="{{ route('admin.lose-number-games-prices.create', ['loseNumberGame' => $loseNumberGame]) }}" class="btn btn-primary font-weight-bolder">
                ...
                <table class="table table-bordered table-hover table-striped table-light yajra-datatable">
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td nowrap="nowrap">
                                @if( $item->basic != 1 )
                                    <a href="{{ route('admin.lose-number-games-prices.edit', [$item->id, 'price_id'=>$item->id] ) }}"
                                    ...
                                    <form action="{{ route('admin.lose-number-games-prices.destroy', $item->id) }}" method="post" id="record_delete_{{ $item->id }}" class="d-none">
                                        @csrf
                                        @method('DELETE')

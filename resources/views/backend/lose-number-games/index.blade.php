...
@section('title', 'قائمة العاب الرقم الخاسر')
    ...
    <div class="container">
        <div class="row ">
            <div class="col-6 d-flex text-left">
                <h1 class=" text-left">قائمة العاب الرقم الخاسر</h1>
            </div>
            <div class="col-6 d-flex justify-content-end">
                <a href="{{ route('admin.lose-number-games.create') }}" class="btn btn-primary font-weight-bolder">
                ...
                <table class="table table-bordered table-hover table-striped table-light yajra-datatable">
                    <thead class="table-dark ">
                        <tr class="text-light">
                            ...
                            <th class="text-light">الرقم الخاسر</th>
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>{{ $item->lose_number }}</td>
                            <td>{{ $item->timer }}</td>
                            <td>{{ $item->start }}</td>
                            <td>{{ $item->end }}</td>

                            @ability('superAdmin', 'manage_lose_number_games,edit_lose_number_games')
                                <td class="text-center">
                            ...
                            @endability
                            <td class="text-center">
                                <a href="{{ route('admin.lose-number-games.showPrices', $item->id) }}" target="_blank">
                            ...
                            <td nowrap="nowrap">
                                @ability('superAdmin', 'manage_lose_number_games,update_lose_number_games')
                                    <a href="{{ route('admin.lose-number-games.edit', $item->id) }}"
                                ...
                                @ability('superAdmin', 'manage_lose_number_games,delete_lose_number_games')
                                    ...
                                    <form action="{{ route('admin.lose-number-games.destroy', $item->id) }}" method="post" id="record_delete_{{ $item->id }}" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                @endability
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        text: 'Delete All',
                        url: "{{ route('admin.lose-number-games.massDestroy') }}",
        ...
        $(function () {
            $('.status-class').change(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{ route('admin.lose-number-games.changeStatus') }}',
                    data: {
                        'status': status,
                        'cat_id': cat_id
                    },

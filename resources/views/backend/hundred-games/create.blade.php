...
@section('content')
    ...
    <div class="container">
        <div class="card-header py-3 d-flex">
            <div class="col-6">
                <h3 class="card-title card-title-new"> اضافة لعبة جديدة ( 100 رقم )</h3>
            </div>
        ...
        <div class="card card-custom gutter-b example example-compact">
            <!--begin::Form-->
            <form action="{{ route('admin.hundred-games.store') }}" method="post" enctype="multipart/form-data" id="forma">
                @csrf
                <div>

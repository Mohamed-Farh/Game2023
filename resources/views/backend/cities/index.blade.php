                ...
                <table class="table table-bordered table-hover table-striped table-light yajra-datatable">
                    <thead class="table-dark ">
                        <tr class="text-light">
                            ...
                            <th class="text-light">اسم المدينة</th>
                            <th class="text-light">اسم المحافظة التابعة لها</th>
                            ...
                            <tr data-entry-id="{{ $city->id }}">
                                ...
                                <td class="text-center">
                                    <span class="switch switch-icon">
                                        <label>
                                            <input data-id="{{ $city->id }}" class="status-class" type="checkbox"
                                ...
                                <td class="text-center">
                                            ...
                                            <a href="javascript:void(0)"
                                                onclick="
                                                    if (confirm('Are You Sure You Want To Delete This Record ?') )
                                                        { document.getElementById('record_delete_{{ $city->id }}').submit(); }
                                                    else
                                                        { return false; }"
                                    ...
                                    <form action="{{ route('admin.cities.destroy', $city->id) }}" method="post" id="record_delete_{{ $city->id }}" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
        ...
        $(function () {
            $('.status-class').change(function() {
                ...
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: '{{ route('admin.cities.changeStatus') }}',
                    data: {
                        'status': status,
                        'cat_id': cat_id
                    },

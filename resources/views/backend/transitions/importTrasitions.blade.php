...
{{--                            <th class="text-light">التحكم</th>--}}
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                @if( $item->complete != 1 )
                                    <span class="label label-lg font-weight-bold label-light-danger label-inline" >غير مكتملة</span>
                                @else
                                    <span class="label label-lg font-weight-bold label-light-info label-inline" >مكتملة</span>
                                @endif
                            </td>
                        </tr>
                    @endforeach

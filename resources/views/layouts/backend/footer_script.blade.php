...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <!--begin::Content-->
    <div class="offcanvas-content pr-5 mr-n5" style="direction: rtl">
        <!--begin::Header-->
        <div class="row d-flex align-items-center mt-5">
            ...
            <div class="col -12d-flex flex-column">
                <a href="#"
                   class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::user()->full_name }}</a>
                {{-- <div class="text-muted mt-1">{{ Auth::user()->roles->display_name }}</div> --}}
                <div class="text-muted mt-1">{{ Auth::user()->mobile }}</div>
                <div class="navi mt-2">
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{ asset('backend/assets/media/stock-600x400/img-1.jpg') }}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{ asset('backend/assets/media/stock-600x400/img-2.jpg') }}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{ asset('backend/assets/media/stock-600x400/img-3.jpg') }}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{ asset('backend/assets/media/stock-600x400/img-4.jpg') }}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
            <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="{{ asset('backend/assets/media/stock-600x400/img-8.jpg') }}" title="" alt="" />
                </a>
            </div>
            <!--end::Item-->
        </div>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo1.png') }}" alt="" class="w-100" />
                </div>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo2.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo2/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo3.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo3/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo4.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo4/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo5.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo5/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo6.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo6/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo7.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo7/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo8.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo8/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo9.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo9/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo10.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo10/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo11.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo11/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo12.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo12/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo13.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="../../../../demo13/dist"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo14.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo15.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo16.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo17.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo18.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo19.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo20.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo21.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo22.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo23.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo24.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo25.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo26.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo27.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo28.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo29.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                <div class="overlay-wrapper rounded-lg">
                    <img src="{{ asset('backend/assets/media/demos/demo30.png') }}" alt="" class="w-100" />
                </div>
                <div class="overlay-layer">
                    <a href="#"
                       class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow disabled opacity-90">Coming
...
<script src="{{ asset('backend/assets/plugins/custom/gmaps/gmaps.js') }}"></script>
<!--end::Page Vendors-->
    ...
    $(function() {
        $(".typeahead").typeahead({
            ...
            source: function(query, process) {
                return $.get("{{ route('admin.players.getPlayerSearch') }}", {
                        'query': query
                    },
                    function(data) {
                        return process(data);
